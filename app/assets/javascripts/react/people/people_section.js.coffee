...
@PeopleSection = React.createClass
  ...
  getInitialState: ->
    ...
    didFetchData: false
    # The people JSON array used to display the card in the view
    people: []
  ...
  # AJAX call to out PeopleController
  _fetchPeople: (data) ->
    $.ajax
  ...
  # props and state...
  render: ->
    # The collection of PersonCard components we are going to dsplay
